...
class shared_storage {
    ...
    BOOST_STATIC_ASSERT(boost::has_equal_to<T>::value);

    private:
        //  shared object value type
        struct shared_storage_vt {
            DRIVER_UINT32   ref_count;
            bool            flag;               // overflow flag for ref_count
            T               val;

            shared_storage_vt(T arg) :    0

Shea690901/fluffos_tmp

    Last release: No release
...
#include <driver_lib/templates/impl/shared_storage.cc>

#endif // VM_shared_storage_HH_
